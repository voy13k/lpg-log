...
public class MainActivity extends ActionBarActivity implements
	...
	static class TabSection {
		int titleResId;
		Class<? extends Fragment> fragmentClass;

		TabSection(int titleResId, Class<? extends Fragment> fragmentClass) {
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			...
			return getString(SECTIONS[position].titleResId).toUpperCase(l);
		}

		@Override
		public Fragment getItem(int position) {
			try {
				return SECTIONS[position].fragmentClass.newInstance();
			} catch (Exception e) {
				return null;
			}
		}
